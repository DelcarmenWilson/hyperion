...
export const PhoneDialerModalOld = () => {
                  ...
                  <div className="flex justify-between items-center gap-2">
                    ...
                    <div className="flex gap-2 items-center">
                      ...
                      <Input
                        ...
                        value={dialMatrix}
                        onChange={(e) =>
                          setDialMatrix(parseInt(e.target.value))
                        }
                        type="number"
                      />
                      {dialing ? (
