...
import { convertUsers } from "@/formulas/inital-data";
import { initialUsers } from "@/actions/initial-data";
  ...
  const onFileUploaded = (e: any) => {
    Papa.parse(e.target.files[0], {
      ...
      complete: function (result: any) {
        const mapped: User[] = convertUsers(result);
        setUsers(mapped);
      },
    });
  };
  ...
  return (
    <div className="h-[500px] flex flex-col gap-2 p-3 bg-background">
      <div className="flex flex-col justify-center items-center">
        <h3 className="text-2xl font-semibold py-2">Import Users</h3>
