...
import { columns } from "@/app/(pages)/(main)/settings/(routes)/config/components/status/columns";

import { DrawerRight } from "@/components/custom/drawer/right";
import { LeadStatusForm } from "@/app/(pages)/(main)/settings/(routes)/config/components/status/form";
