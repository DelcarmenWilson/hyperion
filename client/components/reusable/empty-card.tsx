...
export const EmptyCard = ({ title, subTitle }: EmptyCardProps) => {
  return (
    <Card className="flex flex-1 flex-col w-full h-full overflow-hidden p-0 border-0 shadow-none">
      <CardContent className="flex-center flex-col h-full gap-2 text-muted-foreground  overflow-hidden !px-0 border-0">
        ...
        <TextAnimation text={title} viewBox="0 0 800 160" />
